  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        <div className="bg-[#151A24] border border-[var(--border)] p-5 rounded-2xl text-center shadow-lg hover:border-[#1A75E5]/40 transition-colors">
      ...
      {filteredApplications.length === 0 ? (
        ...
        <div className="space-y-4">
          {filteredApplications.map((application) => {
            ...
            return (
              <div key={application.id} className="bg-[#151A24] border border-[var(--border)] p-6 rounded-2xl hover:border-[#1A75E5]/60 hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(26,117,229,0.12)] transition-all duration-300">
                {/* Application Header */}
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    {/* Job Title */}
                    <h3
                      className="text-xl font-bold mb-2 cursor-pointer text-white hover:text-[var(--accent)] transition-colors leading-tight"
                  ...
                  <div className="space-y-4 pt-4 border-t" style={{ borderColor: 'var(--border)' }}>
                    ...
                    {application.proposal && (
                      <div>
                        ...
                        <div
                          className="bg-[#111620] border border-[var(--border)] rounded-xl p-4 whitespace-pre-wrap text-sm"
                          style={{
