...
export function JobDetailClient({ job, currentProfile, initialBookmarked, existingCallRequest }: JobDetailClientProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Main Content Card */}
      <div className="bg-[#151A24] border border-[var(--border)] p-8 rounded-2xl shadow-xl w-full">
        {/* Header */}
      ...
      {!isOwner && (
        <div className="bg-[#1D2B44]/20 border-2 border-green-500/30 p-8 rounded-2xl shadow-xl bg-gradient-to-br from-[#10b981]/10 via-[#3b82f6]/5 to-[#8b5cf6]/5 relative overflow-hidden">
